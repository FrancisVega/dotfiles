...
_G.packer_plugins = {
  ...
  ["git-conflict.nvim"] = {
    ...
    loaded = true,
    path = "/Users/hisco/.local/share/nvim/site/pack/packer/start/git-conflict.nvim",
  ...
  ["nui.nvim"] = {
    loaded = true,
    path = "/Users/hisco/.local/share/nvim/site/pack/packer/start/nui.nvim",
  ...
  ["vim-multiple-cursors"] = {
    loaded = true,
    path = "/Users/hisco/.local/share/nvim/site/pack/packer/start/vim-multiple-cursors",
  ...
  ["which-key.nvim"] = {
    ...
    loaded = true,
    path = "/Users/hisco/.local/share/nvim/site/pack/packer/start/which-key.nvim",
